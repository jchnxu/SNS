...
class Uploadhandler
{
    ...
    protected function handle_form_data($file, $index) {
        ...
        $file->name = 'user_' . $_REQUEST['user_id'] . '.' . pathinfo($file->name, PATHINFO_EXTENSION);
        // save for later update in database
        $this->file_path = $this->options['upload_url'] . $file->name; 
